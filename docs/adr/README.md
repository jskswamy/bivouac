...
| [0005](0005-module-based-package-composition.md) | Module-based package/flake composition | Accepted (its example predates the move to `cloudlab.pkl`; its `flakes[].modules` is superseded by the [curated modules and settings design](../superpowers/specs/2026-09-18-flake-modules-and-settings-design.md)) |
